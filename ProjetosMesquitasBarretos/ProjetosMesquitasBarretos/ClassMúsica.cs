...
namespace ProjetosMesquitasBarretos
{
    ...
    public class ClassMusica: ClasseMidia,ILocal
    {
        ...
        {
            string dados = "Id" + "|" + m.Id.ToString() + "|" + "Descrição" + "|" + m.Descrição.ToString() + "|" + "Dados" + "|" + m.ArquivoDeDados + "|" + "Formato" + "|" + m.Fmusica + "|" + "Duração" + "|" + m.Duracao.ToString() + "|" + "Volume" + "|" + m.Volume.ToString()+Environment.NewLine;
