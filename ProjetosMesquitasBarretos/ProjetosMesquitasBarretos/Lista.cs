...
namespace ProjetosMesquitasBarretos
{
    class Lista
    {
        ...
        public void InserirNoInicio(ClasseMidia valor)
        {
            InserirNaPosicao(null, valor);
        }
        public void InserirNoFim(ClasseMidia valor)
        {
            if (qtde == 0)
            {
        ...
        public void InserirNaPosicao(ClasseMidia valor, int posicao)
        {
        ...
        public bool Pesquisa(ClasseMidia dado)
        {
            Nodo aux = primeiro;
            while (aux != null)
            {
